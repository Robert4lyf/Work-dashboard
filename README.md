...
- **Promises:** the Promises tab holds what you owe people (**I owe**) and what they owe you (**Waiting for**), each with an optional person and date. Due ones show in the header and get a 9am notification ("Promise due" or "Time to chase"). Closing one adds it to History.
